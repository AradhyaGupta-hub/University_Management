...
public class UpdateStudent extends JFrame implements ActionListener{
    ...
    JTextField tfbranch,tfcourse,tfadrs,tfphn,tfemail;
    JLabel labelrollno;
    ...
    UpdateStudent(){
        ...
        labelrollno.setForeground(Color.GRAY);
        add(labelrollno);
        ...
        JLabel lblaadhr = new JLabel("Aadhar Number");
        lblaadhr.setBounds(400,350,200,30);
        lblaadhr.setFont(new Font("serif",Font.BOLD,20));
        add(lblaadhr);

        JLabel labelaadhr = new JLabel();
        labelaadhr.setBounds(600,350,150,30);
        labelaadhr.setFont(new Font("Tahoma",Font.PLAIN,18));
        add(labelaadhr);
        ...
        try {
            ...
            while (rs.next()){
                ...
                labelaadhr.setText(rs.getString("aadhar"));
