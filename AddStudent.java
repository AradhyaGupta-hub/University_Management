...
public class AddStudent extends JFrame implements ActionListener{
    ...
    JTextField tfname,tffname,tfadrs,tfphn,tfemail,tfx,tfxii,tfadhr;
    JLabel labelrollno;
    JDateChooser dcdob;
    ...
    AddStudent(){
        ...
        labelrollno = new JLabel("21EAYCS"+first4);
        ...
        lbladhr.setBounds(400,350,200,30);
        ...
        String courses[] = {"B-Tech","M-Tect","MBA","BCA","MCA","BSc","MSc","BCOM","MCOM"};
        ...
        String branch[] = {"Computer Science","Electrical","Mechanical","Civil","IT","Aritficial Intelligence","Agricultural"};
