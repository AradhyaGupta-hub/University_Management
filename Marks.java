...
public class Marks extends JFrame implements ActionListener{
    ...
    Marks(String rollno){
        ...
        JLabel heading = new JLabel("Rajasthan Technical University");
        heading.setBounds(90,20,500,25);
        heading.setFont(new Font("Tahoma",Font.BOLD,20));
        add(heading);

        JLabel subheading = new JLabel("  Result of Examination (2024)");
        subheading.setBounds(90,60,500,20);
        ...
        lblsemester.setBounds(60,160,500,20);
        ...
        try {
            ...
            while (rs2.next()) {
                ...
                sub5.setText(sub5.getText() + "        " + rs2.getString("marks1"));
